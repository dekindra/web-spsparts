        ...
        return {
          ...
          templates: {
            buttons: function buttons() {
              ...
              return '<div class="wizard-buttons"><button class="btn btn-default btn-outline" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</button><button class="btn btn-primary btn-outline float-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + '</button><button type="submit" class="btn btn-success btn-outline float-right"  data-wizard="finish" role="button">' + options.buttonLabels.finish + '</button></div>';
            }
          },
          classes: {
            step: {
