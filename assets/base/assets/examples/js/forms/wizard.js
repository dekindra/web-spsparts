    ...
    var options = _jquery2.default.extend(true, {}, defaults, {
      ...
      templates: {
        buttons: function buttons() {
          ...
          var html = '<div class="btn-group btn-group-sm">' + '<button class="btn btn-default btn-outline" href="#' + this.id + '" data-wizard="back" role="button">' + options.buttonLabels.back + '</button>' + '<button type="submit" class="btn btn-success btn-outline float-right" href="#' + this.id + '" data-wizard="finish" role="button">' + options.buttonLabels.finish + '</button>' + '<button class="btn btn-default btn-outline float-right" href="#' + this.id + '" data-wizard="next" role="button">' + options.buttonLabels.next + '</button>' + '</div>';
          return html;
        }
      },
      buttonLabels: {
