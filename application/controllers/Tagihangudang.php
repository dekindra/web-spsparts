...
class Tagihangudang extends CI_Controller {
	...
	private function getData(){
        $data = array(
            ...
            'menu' => "tagihangudang",
            'posisi' => "tagihan",
            'content' => "admin/tagihan/tagihan-gudang",
            'param'=> array(
                // 'tagihans' => $this->Tagihan_model->getAllAccount(),
                'tagihans' => $this->Tagihan_model->getDataTagihanGudang(),
