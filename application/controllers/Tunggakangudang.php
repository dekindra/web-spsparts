...
class Tunggakangudang extends CI_Controller {
	...
	private function getData(){
        $data = array(
            ...
            // 'breadcumb' => "",
            'menu' => "tunggakangudang",
            'posisi' => "tagihan",
            'content' => "admin/tagihan/tunggakan-gudang",
            'param'=> array(
                'tunggakans' => $this->Tagihan_model->getDataTunggakanGudang(),
