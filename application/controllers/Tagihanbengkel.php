...
class Tagihanbengkel extends CI_Controller {
	...
	private function getData(){
        ...
        $data = array(
            'title' => "Tagihan Order",
            // 'breadcumb' => "",
            'menu' => "tagihankebengkel",
            'posisi' => "tagihan",
            'content' => "admin/tagihan/tagihan-bengkel",
            'param'=> array(
                'tagihans' => $this->Tagihan_model->getDataTagihanBengkel($outlet_id),
