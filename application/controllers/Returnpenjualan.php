...
class Returnpenjualan extends CI_Controller {
	...
	private function getData(){
        $data = array(
            ...
            // 'breadcumb' => "",
            'menu' => "returnpenjualan",
            'posisi' => "aplikasi",
            'content' => "admin/penjualan/return-penjualan",
            'param'=> array(
...
/* End of file ReturnPenjualan.php */
/* Location: ./application/controllers/ReturnPenjualan.php */
