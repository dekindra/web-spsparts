...
class Wishlistbengkel extends CI_Controller {
	...
	private function getData(){
        ...
        $data = array(
            ...
            // 'breadcumb' => "",
            'menu' => "wishlistbengkel",
            'posisi' => "orderbengkel",
            'content' => "admin/order/order-wishlistbengkel",
            'param'=> array(
                'wishlist' => $this->Wishlist_model->getWishlist('bengkel', $outlet_id),
                'totalwishlist' => $this->Wishlist_model->getTotalWishlist('bengkel', $outlet_id),
