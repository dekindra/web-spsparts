...
<head>
  ...
  <title>Pendaftaran Partnership</title>
  <style type="text/css">
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
                  ...
                  <tr>
                    ...
                    <td width="400" align="center" style="padding-bottom:5px;">
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" >
                          <p >Selamat bergabung keluarga baru PT. SURYA PRANA SESAMA. Terimakasih telah mendaftar untuk menjadi mitra kami.</p>
                        </div>
                      </div>
                    </td>
                    <td width="100">&nbsp;</td>
                      ...
                      <table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
                        <tr>
                          <td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
                            <div class="contentEditableContainer contentTextEditable">
                              <div class="contentEditable" >
                                <a class='link2'>Login</a>
                                <!-- <a target='_blank' href="[CLIENTS.WEBSITE]" class='link2'>Login</a> -->
                              </div>
                            </div>
                      ...
                      <table cellpadding="0" style="border-collapse:collapse;" cellspacing="0" border="0" align="center" width="600">
                        <tr>
                          ...
                          <td width="400" valign="top" style="padding-top:40px;padding-bottom:20px;">
                            ...
                            <div class="contentEditableContainer contentTextEditable">
                              <div class="contentEditable" >
                                <div style="font-size:23px;font-family:Heveltica, Arial, sans-serif;color:#fff;">Data pendaftaran partnership.</div>
                                <p style='color:#FFEECE;'>Silahkan disimpan untuk keperluan Login!</p>
                              </div>
                            </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
                  ...
                  <tr>
                    <td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
                      <div class="contentEditableContainer contentTextEditable">
                        <div class="contentEditable" >
                          <span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Sent by PT. SURYA PRANA SESAMA</span>
                          <br/>
                          <span style="font-size:11px;color:#555;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Jl.Merak Raya Blok H1 No.120,Cikarang Baru, Jababeka, Cikarang | 021- 8932 4604 / 0812 9575 663</span>
                          <br/>
