...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Forgot password | SPS Parts</title>
    
    <link rel="apple-touch-icon" href="<?php echo base_url(); ?><?php echo base_url(); ?>assets/base/assets/images/apple-touch-icon.png">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/flag-icon-css/flag-icon.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/base/assets/examples/css/pages/forgot-password.css">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        ...
        <!-- <form method="post" role="form"> -->
          ...
          <div class="form-group">
            <button type="submit" name="btnSubmit" value="Submit" class="btn btn-primary btn-block">Reset Your Password</button>
          </div>
          <?php echo form_close(); ?>
        <!-- </form> -->
