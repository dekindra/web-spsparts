            ...
            <table class="table table-hover dataTable table w-full" id="exampleTableTools">
              ...
              <tbody>
                ...
                <?php
                  ...
                  <tr>
                    <!-- <td><?php echo $i; ?></td> -->
                    <td class=""><?php echo $gd -> name; ?></td>
                    <td class=""><?php echo $gd -> instansi; ?></td>
                    <td class=""><?php echo $gd -> address; ?></td>
                    <td class=""><?php echo $gd -> pj; ?></td>
                    <td class=""><?php echo $gd -> tel; ?></td>
                    <td class="">Rp. <?php echo formatRP($gd -> nomorder); ?></td>
                    <td class="">
                    <?php
                      if ($gd -> status == '1') {
                  ...
                  ?>
                    ...
                    <td class="text-nowrap">
                      <button type="button" class="btn btn-sm btn-icon btn-info btn-outline" data-toggle="tooltip"
                                data-original-title="Edit" onclick="edit_account(<?php echo $gd -> id_gudang; ?>)">
                                <i class="icon wb-wrench" aria-hidden="true"></i>
                      </button>
                      <button type="button" class="btn btn-sm btn-icon btn-danger btn-outline" data-toggle="tooltip"
                                data-original-title="Delete" onclick="delete_account(<?php echo $gd -> id_gudang; ?>)">
                                <i class="icon wb-close" aria-hidden="true"></i>
                      </button>
                    </td>
                  </tr> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="form-group form-material floating" data-plugin="formMaterial">
                                    ...
                                    <label class="floating-label" id="label-photo1">Rencana Gudang..</label>
                                  </div>
                                </div>
                              </div>
                            </form>
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.ktp)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'assets/images/gudang/'+data.ktp+'" class="img-responsive" style="width: 160px">'); // show photo
            ...
            if(data.wh)
            {
                $('#label-photo1').text('Change Gudang..'); // label photo upload
                $('#photo-preview1 div').html('<img src="'+base_url+'assets/images/gudang/'+data.wh+'" class="img-responsive" style="width: 160px">'); // show photo
                $('#photo-preview1 div').append('<br><input type="checkbox" name="remove_photo1" value="'+data.wh+'"/> Remove photo when saving<br><br>'); // remove photo

            }
            else
            {
                $('#label-photo1').text('Upload Gudang..'); // label photo upload
