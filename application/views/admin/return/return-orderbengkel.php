              ...
              <div class="modal-content">
                ...
                <form autocomplete="off" id="form" class="formmodaltambah">
                  <div class="modal-body">
                    ...
                    <div class="col-md-6">
                      <label for=""><b>TOTAL RETURN</b></label>
                      <input id="rupiah" type="hidden" name="total_retur" class="form-control"><br>
...
<!-- <table class="table table-hover dataTable table w-full" data-plugin="dataTable" > -->
  <table class="table table-hover dataTable table w-full" id="exampleTableTools" >
      ...
      if (!is_null($returns))
        foreach ($returns as $or) {
          ...
          <!-- <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip"
                  ...
                  data-original-title="Delete" onclick="delete_account(<?php echo $or->id_retur; ?>)">
    ...
    <div class="panel">
      <header class="panel-heading">
        <h3 class="panel-title">Laporan Return Order</h3>
      </header>
      <div class="panel-body">
        <!-- Example Date Range -->
...
<script>
  (function($) {
      ...
      $('body').on('click',"#autocomplete"+ (currentId + 1), function(){
        $("#autocomplete"+ (currentId + 1)).autocomplete({    
          ...
          source:function( request, result ) {
            $.ajax({
              url: '<?php echo site_url('returnbengkel/autocompleteproduk') ?>',
              dataType: "json",
    ...
    function hitungTotal(){
      ...
      $('.hitungTotal').each(function(){
        ...
        $('input[name=total_retur]').val(total)
  ...
  function save()
  {
    ...
    url = "<?php echo site_url('returnbengkel/add')?>";
  ...
  function detail_account(id)
  {
    ...
    $.ajax({
      url : "<?php echo site_url('returnbengkel/ajax_edit')?>/" + id,
      type: "GET",
        // dataType: "JSON",
        success: function(data)
        {
  ...
  function delete_account(id)
  {
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
          url : "<?php echo site_url('returnbengkel/delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
    ...
    $('document').ready(function(){
      $('#formLapPenjualan').submit(function(e){
        ...
        $.ajax({
          type: "POST",
          url: '<?php echo site_url('returnbengkel/lapReturnBy') ?>',
