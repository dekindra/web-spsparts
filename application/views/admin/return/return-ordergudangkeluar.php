...
<script>
      ...
      $('body').on('click',"#autocomplete"+ (currentId + 1), function(){
        $("#autocomplete"+ (currentId + 1)).autocomplete({    
          ...
          source:function( request, result ) {
            $.ajax({
              url: '<?php echo site_url('returngudang/autocompleteproduk') ?>',
              dataType: "json",
  ...
  function save()
  {
    ...
    url = "<?php echo site_url('returngudang/add')?>";
  ...
  function detail_account(id)
  {
    ...
    $.ajax({
      url : "<?php echo site_url('returngudang/ajax_edit')?>/" + id,
      type: "GET",
        // dataType: "JSON",
        success: function(data)
        {
  ...
  function delete_account(id)
  {
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
          url : "<?php echo site_url('returngudang/delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
    ...
    $('document').ready(function(){
      $('#formLapPenjualan').submit(function(e){
        ...
        $.ajax({
          type: "POST",
          url: '<?php echo site_url('returngudang/lapReturnBy') ?>',
