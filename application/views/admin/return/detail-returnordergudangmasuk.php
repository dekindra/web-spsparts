        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <?php if ($data["status_retur"] == 0): ?>
                <button type="button" class="btn btn-animate btn-animate-side btn-success btn-outline" data-toggle="tooltip"
                  data-original-title="Diterima" onclick="diterima_account(<?php echo $data["id_retur"]; ?>)">
                  <span><i class="icon wb-print" aria-hidden="true"></i> Diterima</span>
                </button>
              <?php endif ?>
                <a href="<?php echo base_url() ?>returngudang/cetakmasuk/<?php echo $data["id_retur"]; ?>">
