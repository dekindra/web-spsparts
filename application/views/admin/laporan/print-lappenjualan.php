          ...
          <div class="panel-body container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-6 text-right">
                ...
                <address>
                  <abbr title="Mail">Total Transaksi:</abbr>&nbsp;&nbsp;Rp. <?php echo formatRP($judulpenjualan->totaltransaksi); ?>
                  <br>
                  <abbr title="Phone">Total Pembelian:</abbr>&nbsp;&nbsp;Rp. <?php echo formatRP($judulpenjualan->totalpembelian); ?>
                  <br>
                  <abbr title="Phone">Total Diskon:</abbr>&nbsp;&nbsp;Rp. <?php echo formatRP($judulpenjualan->totaldiskon); ?>
                  <br>
                  <abbr title="Phone">Total Keuntungan:</abbr>&nbsp;&nbsp;Rp. <?php echo formatRP($judulpenjualan->totalkeuntungan); ?>
                </address>
