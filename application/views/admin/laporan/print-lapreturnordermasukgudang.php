  ...
  <head>
    ...
    <script>
     ...
     <style type="text/css" media="print">
      ...
      body {breturn: 0px ; padding: 16px;} 
      th {vertical-align: middle !important; text-align: center;breturn: 0px ;}
      td {breturn: 0px s}
    </style>
          ...
          <div class="panel-body container-fluid">
            ...
            <div class="row">
              <div class="col-6">
                <p>
                  Return to Gudang :
                  <br><b><?php echo $bengkel['nameg']; ?></b>
                </p>
                <address>
                  <?php echo $bengkel['addressg']; ?>
                  <br>
                  <abbr title="Mail">E-mail:</abbr>&nbsp;&nbsp;<?php echo $bengkel['emailg']; ?>
                  <br>
                  <abbr title="Phone">Phone:</abbr>&nbsp;&nbsp;<?php echo $bengkel['telg']; ?>
                </address>
              </div>
              <div class="col-6 text-right">
                ...
                <address>
                  ...
                  <br>
                  <abbr title="Instansi">Instansi:</abbr>&nbsp;&nbsp;<?php echo $bengkel['instansi']; ?>
                  <br>
                  <abbr title="Mail">E-mail:</abbr>&nbsp;&nbsp;<?php echo $bengkel['email']; ?>
                  <br>
                  <abbr title="Phone">Phone:</abbr>&nbsp;&nbsp;<?php echo $bengkel['tel']; ?>
                  <br>
                  <abbr title="Trans">Total Transaksi:</abbr>&nbsp;&nbsp;<?php echo $judulreturn->totaltransaksi; ?>
                  <br>
                  <abbr title="return">Total return:</abbr>&nbsp;&nbsp;Rp. <?php echo formatRP($judulreturn->totalreturn); ?>
                  <br>
                </address>
