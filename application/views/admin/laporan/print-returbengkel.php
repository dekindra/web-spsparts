          ...
          <div class="panel-body container-fluid">
            ...
            <div class="row">
              <div class="col-6">
                <p>
                  RETURN TO GUDANG :
                  <br><b><?php echo $data['nameg']; ?></b>
                </p>
                <address>
                  <?php echo $data['addressg']; ?>
                  <br>
                  <abbr title="Fax">Instansi:</abbr>&nbsp;&nbsp;<?php echo $data['instansig']; ?>
                  <br>
                  <abbr title="Mail">E-mail:</abbr>&nbsp;&nbsp;<?php echo $data['emailg']; ?>
                  <br>
                  <abbr title="Phone">Phone:</abbr>&nbsp;&nbsp;<?php echo $data['telg']; ?>
                </address>
              </div>
              <div class="col-6 text-right">
                ...
                <span>Tanggal Return: <?php echo date("d M Y",strtotime($return['created_datetime'])); ?></span>
              </div>
            </div>
