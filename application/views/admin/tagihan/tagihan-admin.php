...
//     $.ajax({
//         url : "<?php echo site_url('tagihanadmin/uploadbukti')?>/" + id,
//         type: "GET",
//         dataType: "JSON",
...
function save()
{
    ...
    url = "<?php echo site_url('tagihanadmin/add')?>";
...
function detail_account(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('tagihanadmin/detail')?>/" + id,
        type: "GET",
        // dataType: "JSON",
        success: function(data)
        {
...
function delete_pembayaran(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('tagihanadmin/delete_pembayaran')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
