            ...
            <table class="table table-hover dataTable table w-full" id="exampleTableTools" >
              <thead>
                <tr>
                  ...
                  <th style="background:  #ececec;" class="text-nowrap">Action</th>
                </tr>
              </thead>
              <tbody>
                <!-- <tr>
                  ...
                  <td>2018-06-04</td>
                  <td>300000</td>
                  <td><span class="badge badge-lg badge-danger">Menunggak</span></td>
                ...
                <tr>
                  ...
                  <td>2018-05-17</td>
                  <td>200000</td>
                  <td><span class="badge badge-lg badge-success">Lunas 2018-05-17</span></td>
                  <td class="text-nowrap">
                    <button type="button" class="btn btn-sm btn-icon btn-info btn-outline" data-toggle="tooltip"
                              data-original-title="Detail">
                              <i class="icon wb-info-circle" aria-hidden="true"></i>
...
function detail_account(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('tunggakangudang/detail')?>/" + id,
        type: "GET",
        // dataType: "JSON",
        success: function(data)
        {
