  ...
  function validasibukti(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('tagihanbengkel/getvalidasibukti')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function validasi(id)
{
    ...
    url = "<?php echo site_url('tagihanbengkel/validasibukti')?>/" + id;
...
function batalvalidasi(id)
{
    ...
    url = "<?php echo site_url('tagihanbengkel/batalvalidasibukti')?>/" + id;
...
function detail_account(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('tagihanbengkel/detail')?>/" + id,
        type: "GET",
        // dataType: "JSON",
        success: function(data)
        {
