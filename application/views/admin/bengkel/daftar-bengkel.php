        <form id="exampleWizardForm" action="<?=base_url()?>bengkel/insert" method="post" enctype="multipart/form-data">   
           <!-- Panel Wizard Form -->
           <?php
            ...
            <div class="panel" style="text-align: left;"  id="exampleWizardForm">
              <div class="panel-heading">
                <h3 class="panel-title">Form Pendaftaran Bengkel</h3>
              </div>
                ...
                <div class="wizard-content">
                  ...
                  <div class="wizard-pane" id="exampleBilling" role="tabpanel">
                    <div id="exampleBillingForm">
                      ...
                      <div class="form-group form-material floating" data-plugin="formMaterial">
                        <select class="form-control" name="gudang" required="required">
                          <option>&nbsp;</option>
                          <?php foreach ($gudangs as $gdg) { ?>
                            <option value="<?php echo $gdg->id_gudang; ?>"><?php echo $gdg->name; ?> [area : <?php echo $gdg->area; ?>]</option>
                          <?php } ?>
                        </select>
                      ...
                      <div class="row">
                        ...
                        <!-- <div class="col-md-6">
                          <div class="form-group form-material floating" data-plugin="formMaterial">
                            ...
                            <label class="floating-label">Photo Rencana Bengkel..</label>
                          </div>
                        </div> -->
                        <div class="col-md-6">
                          <!-- Example max file size -->
                          <div class="">
                            <h4 class="example-title">KTP Penanggung Jawab.. (PNG/JPG)</h4>
                            <div class="example">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="">
                            ...
                            <div class="example">
                              <input type="file" name="ws" id="input-file-max-fs" data-plugin="dropify" data-max-file-size="1M"
                              />
                            </div>
                          </div>
                          <!-- End Example max file size -->
