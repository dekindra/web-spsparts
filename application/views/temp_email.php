                    ...
                    <center>
                      <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                        <tr>
                          ...
                          <br>
                          <br>
                            <span style="color:#ffffff;"><?=$pj?></span> <br>

                          </td>
                         <!--  <td style="text-align:right; vertical-align:top; color:#933f24">
                          <br>
                          <br>
                          <?php $refnum = substr($idpeserta,5,4); ?>
                            <span style="color:#ffffff;">Pendaftar : <?=$refnum?></span> <br>
                            <span style="color:#ffffff;">Tempat : Citra 2 Universitas Amikom Yogyakarta <br> <a href="s.id/lokasiseminar"> <b>Map</b> :s.id/lokasiseminar </a> </span> <br>
                            <span style="color:#ffffff;">Acara : 12 April 2018</span> <br>
                            <span style="color:#ffffff;">Jam : 08:00 - 13:00</span> <br>
                      ...
                      <table  style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                        <tr>
                          ...
                          <br>
                          <br>
                          Pendaftaran akan segera ditindaklanjuti, mohon kesediaannya untuk menunggu. Kami akan segera menghubungi kembali. 
                            <br>
                            <br>
                          </td>
                        </tr>
